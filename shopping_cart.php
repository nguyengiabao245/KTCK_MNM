    ...
    <tbody>
        <?php
            ...
            if(isset($_SESSION["cart_items"]) && count($_SESSION['cart_items'])>0){
                ...
                echo "<tr> <td colspan=3><p class='text-right'><button type='button' class='btn btn-primary'>Tiếp tục mua hàng</button></p></td><td colspan=2><p class='text-right'><button type='button' class'btn btn-success'>Thanh toán</button></td></tr>";
            }
            else{
                echo "không có sản phẩn nào trong giỏ hàng";
            }
            ?>
    </tbody>
</table>
